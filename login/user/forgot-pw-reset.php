...
if ($_SERVER["REQUEST_METHOD"] === "GET") {
    ...
    if (!$user) {
        die("<script>alert('Token not found'); window.location.href='/NeoExclusiveCafe/pages/auth/login-signup.php';</script>");
    }

    if (strtotime($user["reset_token_expires_at"]) <= time()) {
        die("<script>alert('Token has expired'); window.location.href='/NeoExclusiveCafe/pages/auth/login-signup.php';</script>");
    }
    ...
    if (!$user) {
        die("<script>alert('Invalid token'); window.location.href='/NeoExclusiveCafe/pages/auth/login-signup.php';</script>");
    }
    ...
    echo "<script>alert('Password successfully updated!'); window.location.href='/NeoExclusiveCafe/pages/auth/login-signup.php';</script>";
    exit;
}
?>
<!DOCTYPE html>
