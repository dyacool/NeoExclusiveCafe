...
if (isset($_POST['signup-submit'])) {
    ...
    if (empty($error)) {
        ...
        try {
            ...
            $verificationLink = get_full_url("/php/auth/verify-email.php?token=" . $token);
            $mail->Body = <<<END
            <p>Hello $firstname,</p>
...
<head>
    ...
    <link rel="stylesheet" href="/frontend/pages/home/login-signup.css">
    <script src="/frontend/pages/home/login-signup.js"></script>
    <style>
