...
<head>
    ...
    <title>Shopping Cart - Pre-Order</title>
    <style>
        .confirmation-modal {
            display: none;
            position: fixed;
        ...
        .page-transition-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(37, 96, 53, 0.95), rgba(26, 74, 42, 0.95));
            z-index: 9999;
            display: none;
            opacity: 0;
...
<div class="wrapper fade-in">
    <div class="main-container">
        ...
        <div class="cart-type-navigation">
            <a href="shopping-cart-preorder.php" class="cart-tab active" id="preorderTab" onclick="smoothSwitchToPage('shopping-cart-preorder.php', event); return false;">Pre-Order</a>
            <a href="shopping-cart-sameday.php" class="cart-tab " id="samedayTab" onclick="smoothSwitchToPage('shopping-cart-sameday.php', event); return false;">Same-Day Order</a>
        </div>
        ...
        <form method="POST" action="checkout.php" id="cartForm">
            ...
            <input type="hidden" name="cart_type" value="preorder">
                ...
                <div class="cart-container">
                    <div class="cart-content">
                        ...
                        <div class="no-items-message">
                            No pickup products in your pre-order cart
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="cart-section">
                        ...
                        <?php else: ?>
                        <div class="no-items-message">
                            No delivery products in your pre-order cart
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
...
function preloadPage(targetPage) {
    return new Promise((resolve, reject) => {
        ...
        link.onload = () => {
            showPreloadIndicator(`${targetPage.includes('sameday') ? 'Same-Day' : 'Pre-Order'} cart ready`);
            resolve();
        };
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const otherPage = 'shopping-cart-sameday.php';
...
window.addEventListener('load', function() {
    // Prefetch same-day cart
    const prefetchLink = document.createElement('link');
    prefetchLink.rel = 'prefetch';
    prefetchLink.href = 'shopping-cart-sameday.php';
